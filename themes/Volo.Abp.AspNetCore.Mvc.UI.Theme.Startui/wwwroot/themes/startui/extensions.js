        ...
        i = {
            ...
            use: function (e, n) {
                i.framework = e.toLowerCase(),
                    i.breakpoints = "bootstrap" === i.framework || "foundation" === i.framework ? t.detectionDivs[i.framework] : n,
            ...
            function i(t, i) {
                function n(i) {
                    ...
                    if (I = i, void 0 === L) d = t.scrollTop(),
                        ...
                        F = e('<div class="jspContainer" />').css({
                            width: O + "px",
                            height: q + "px"
                        }).append(L).appendTo(t);
                    else {
                    ...
                    L.css("overflow", "auto"),
                        ...
                        $ = Q > 1,
                        K = G > 1,
                        K || $ ? (t.addClass("jspScrollable"), s = I.maintainPosition && (_ || te), s && (a = D(), c = T()), o(), r(), l(), s && (y(g ? N - O : a, !1), k(v ? V - q : c, !1)), S(), A(), E(), I.enableKeyboardNavigation && Y(), I.clickOnTrack && p(), z(), I.hijackInternalLinks && W()) : (t.removeClass("jspScrollable"), L.css({
                            top: 0,
                            left: 0,
                            width: F.width() - me
                        }), H(), P(), X(), f()),
                        I.autoReinitialise && !ve ? ve = setInterval(function () {
                            n(I)
                        },
                            I.autoReinitialiseDelay) : !I.autoReinitialise && ve && clearInterval(ve),
                                ...
                                if (void 0 === t.originalTarget || t.originalTarget == t.currentTarget) {
                                    var i, n = e(this),
                                        ...
                                        a = function () {
                                            ...
                                            i = setTimeout(a, r ? I.initialDelay : I.trackClickRepeatFreq),
                                                r = !1
                                        },
                                        l = function () {
                                            i && clearTimeout(i),
                ...
                function g(e) {
                    void 0 === e && (e = U.position().top),
                        F.scrollTop(0),
                        _ = e || 0;
                    var i = 0 === _,
                        n = _ == Z,
                        o = e / Z,
                        s = -o * (V - q); (we != i || ye != n) && (we = i, ye = n, t.trigger("jsp-arrow-change", [we, ye, ke, xe])),
                            b(i, n),
                            L.css("top", s),
                ...
                function j(e) {
                    ...
                    var i = 0 === te,
                        n = te == ee,
                        o = e / ee,
                        s = -o * (N - O); (ke != i || xe != n) && (ke = i, xe = n, t.trigger("jsp-arrow-change", [we, ye, ke, xe])),
                            w(i, n),
                            L.css("left", s),
                ...
                function S() {
                    L.find(":input,a").unbind("focus.jsp").bind("focus.jsp",
                        function (e) {
                            x(e.target, !1)
                        })
                }
                ...
                function Y() {
                    ...
                    K && s.push(ce[0]),
                        ...
                        t.attr("tabindex", 0).unbind("keydown.jsp keypress.jsp").bind("keydown.jsp",
                            function (t) {
                                if (t.target === this || s.length && e(t.target).closest(s).length) {
                                    ...
                                    return o = t.keyCode == n && r != te || a != _,
                                        !o
                                }
                            }).bind("keypress.jsp",
                                function (t) {
                                    return t.keyCode == n && i(),
                                        t.target === this || s.length && e(t.target).closest(s).length ? !o : void 0
                                }),
                ...
                function E() {
                    var e, t, i, n, o, s = !1;
                    F.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp",
                        function (r) {
                            ...
                            function (r) {
                                if (s) {
                                    var a = r.originalEvent.touches[0],
                                        l = te,
                                        c = _;
                                    return be.scrollTo(e + i - a.pageX, t + n - a.pageY),
                                        o = o || Math.abs(i - a.pageX) > 5 || Math.abs(n - a.pageY) > 5,
                                        l == te && c == _
                                }
                            }).bind("touchend.jsp",
                                function () {
                ...
                "border-box" === t.css("box-sizing") ? (ge = 0, me = 0) : (ge = t.css("paddingTop") + " " + t.css("paddingRight") + " " + t.css("paddingBottom") + " " + t.css("paddingLeft"), me = (parseInt(t.css("paddingLeft"), 10) || 0) + (parseInt(t.css("paddingRight"), 10) || 0)),
                    e.extend(be, {
